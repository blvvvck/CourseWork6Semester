...
//  Tools
//
//  Created by Rinat Mukhammetzyanov on 04/01/2018.
...
@IBDesignable public class Button: UIButton {
    ...
    public var touchEdgeOutset = UIEdgeInsets.zero
    ...
    public func applyState() {
        if self.isEnabled {
            if self.isHighlighted {
                UIView.transition(with: self, duration: 0.1, options: Constants.transitionOptions, animations: {
